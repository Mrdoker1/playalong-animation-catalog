...
let valueEl = null;
let currentScore = 86;
function frameScore(slot, scale, color, value) {
    slot.innerHTML = `
    <div style="
      font-family:Arial,Helvetica,sans-serif;
...
export const Score = {
    ...
    title: 'Score',
    game: 'Common',
    description: 'When the player earns points, the Score value briefly scales up and flashes green before settling back to its resting gold colour. Used by both Family Feud and Card Sharks game timers.',
