...
`;
let note = null;
function frameNote(slot, tx, ty, scale, opacity) {
    slot.innerHTML = `
    <div style="
...
export const InfoNote = {
    ...
    title: 'Info Note',
    game: 'Card Sharks',
    description: 'Persistent D-pad helper that lives in the bottom-left of the player screen. Black-glass card with two-line text and inline white key-cap glyphs for ↑ / ↓ that mirror the Higher/Lower buttons. Slides up-and-right into place on mount and then stays static.',
