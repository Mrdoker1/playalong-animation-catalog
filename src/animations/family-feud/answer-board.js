...
let nameEl = null;
let pointsEl = null;
function renderFrameRow(slot, opts) {
    slot.innerHTML = `
...
export const AnswerBoard = {
    ...
    title: 'Answer Board',
    game: 'Family Feud',
    description: 'When the player guesses correctly, the matching row flips open on the X-axis, swapping its blue "hidden" skin for the green "revealed" skin. Back-ease curve overshoots past the end then settles. The answer text fades up from beneath after the row lands.',
