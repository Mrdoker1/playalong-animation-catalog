...
let attemptIdx = 0;
const sequence = [
    { text: 'pizza', kind: 'incorrect' },
    { text: 'burger', kind: 'correct' },
    { text: 'tacos', kind: 'incorrect' },
];
function frameAttempt(slot, translateY, opacity, color, strike, text) {
    slot.innerHTML = `
    <div style="
      font-family:Arial,Helvetica,sans-serif;
...
export const Attempts = {
    ...
    title: 'Attempts',
    game: 'Family Feud',
    description: 'When the player submits a guess, a new row slides into the Attempts column from above. Correct rows render in green, incorrect rows render in red with a strike-through.',
    ...
    play({ duration, easing }) {
        ...
        const rows = container.querySelectorAll('.preview-ff-attempts__row');
