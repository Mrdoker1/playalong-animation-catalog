...
let dots = [];
let strikeIdx = 0;
function frameStrike(slot, scale, rotate, opacity) {
    slot.innerHTML = `
    <div style="
...
export const Strikes = {
    ...
    title: 'Strikes',
    game: 'Family Feud',
    description: 'On a wrong answer, the next strike X icon pops in with a rotation and scale overshoot. Back-ease curve gives the X a satisfying "punch" landing.',
    ...
    `;
        dots = Array.from(stage.querySelectorAll('.preview-ff-strike'));
        strikeIdx = 0;
